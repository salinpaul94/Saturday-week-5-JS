...
let track_list = [
  {
    ...
    path: "songs/Positions - Ariana Grande- [PagalWorld.NL].mp3"
  },
  {
    name: "Last Friday Night (T.G.I.F)",
    artist: "Katy Perry",
    image: "https://picsum.photos/320/180",
    path: "songs/Last Friday Night (T.G.I.F) - Katy Perry- [PagalWorld.NL].mp3"
  },
  {
    name: "Numb",
    artist: "Linkin Park",
    image: "https://picsum.photos/480/270",
    path: "songs/Numb20Official20Video20-20Linkin20Park-kXYiU_JCYtU.mp3",
  },
  {
    name: "Somebody To Love",
    artist: "Justin Bieber",
    image: "https://picsum.photos/240/180",
    path: "songs/Somebody To Love - Justin Bieber- [PagalWorld.NL].mp3",
  }
];
...
function seekUpdate() {
  ...
  let total_minutes = ( Math.floor( curr_track.duration / 60 ) ).toString().padStart( 2, '0');
  let total_seconds = ( Math.floor( curr_track.duration - total_minutes * 60 ) ).toString().padStart( 2, '0');
  total_duration.innerText = total_minutes + ':' + total_seconds;
}
